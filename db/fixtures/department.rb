...
Department.seed( :id,
  ...
  { id: 23 , name_ja: '[学部]物質材料工学課程'}            ,
  { id: 24 , name_ja: '[修士]物質材料工学専攻'}            ,
  { id: 25 , name_ja: '[学部]環境社会基盤工学課程'}        ,
  { id: 26 , name_ja: '[修士]環境社会基盤工学専攻'}        ,
  { id: 27 , name_ja: '[学部]情報・経営システム工学課程'}  ,
  { id: 28 , name_ja: '[修士]情報・経営システム工学専攻'}
)
